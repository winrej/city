...
-- SUBURBAN / EXTRA (14)
('Alea Residences',     'alea-residences', 'DMCI Homes',               'Bacoor, Cavite',                'Bacoor',         '₱4.2M',  4.2,  'RFO',         2, 1,   '62.0 sq.m.', 'First medium-rise development of DMCI Homes in Bacoor, Cavite. Nestled in a quiet location yet highly accessible to major thoroughfares.',                                                                                      '["Neo-Asian Balinese design","Near CAVITEX and Emilio Aguinaldo Hwy","Large central gardens","Secure gated community"]',120),
