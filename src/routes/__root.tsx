  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      links: [
        ...
        { rel: "icon", href: "/favico/favicon.ico", sizes: "any" },
        ...
        {
          rel: "stylesheet",
          href: "https://fonts.googleapis.com/css2?family=Dancing+Script:wght@600;700&family=JetBrains+Mono:wght@400;500;700&family=Montserrat:wght@400;500;600;700;800;900&display=swap",
        },
      ],
    };
  },
...
function RootShell({ children }: { children: ReactNode }) {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Organization",
        "@id": "https://cityqlo.com/#organization",
        name: "CityQlo",
        ...
        sameAs: [
          ...
          "https://www.linkedin.com/company/cityqlo",
          "https://www.tiktok.com/@cityqlo",
        ],
      },
      {
        "@type": "WebSite",
        "@id": "https://cityqlo.com/#website",
        url: "https://cityqlo.com",
        name: "CityQlo",
        description: "Premium property advisory for Filipino professionals, investors, and OFWs.",
        publisher: { "@id": "https://cityqlo.com/#organization" },
        inLanguage: "en-PH",
        potentialAction: {
          "@type": "SearchAction",
          target: {
            "@type": "EntryPoint",
            urlTemplate: "https://cityqlo.com/properties?q={search_term_string}",
          },
